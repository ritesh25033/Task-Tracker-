...
import { List, Box, ToggleButtonGroup, ToggleButton, Typography, CircularProgress } from "@mui/material"
    ...
    <Box>
      ...
      <List>
        {filteredTodos.map((todo) => (
          <TodoItem key={todo.id} todo={todo} onDelete={deleteTodo} onToggle={toggleTodo} onUpdate={updateTodo} />
        ))}
      </List>
